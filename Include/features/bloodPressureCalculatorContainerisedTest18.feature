...
Feature: Check Using Scenario Outline - Negaive Test
  ...
  Scenario Outline: Test case 18
    ...
    |"bloodPressureKs1"			|"70"			   |"40"			 |"15"			|"Ideal Blood Pressure"			|"Average value for your age group [15-19] is 120/78"|"Mean Arterial Pressure : 151" |"Pulse Pressure : 11"|
    |"bloodPressureKs1"			|"90"			   |"60"			 |"20"			|"High Blood Pressure"		|"Average value for your age group [20-24] is 120/79"|"Mean Arterial Pressure : 131" |"Pulse Pressure : 21"|
    |"bloodPressureKs1"			|"140"			 |"80"			 |"25"			|"Low Blood Pressure"|"Average value for your age group [25-29] is 121/80"|"Mean Arterial Pressure : 193" |"Pulse Pressure : 31"|
